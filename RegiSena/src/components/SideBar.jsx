...
import { FaLaptop, FaChartBar, FaAddressBook, FaChevronRight, FaChevronLeft, FaSignInAlt, FaLock, FaGrinBeam } from 'react-icons/fa';
      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        <div>
          ...
          <Nav.Item>
            ...
            <Link className="d-flex align-items-center ps-4 text-decoration-none text-success" to={"/crud-page-ingresos"}>
              <FaChevronRight className="me-2" />
              <span>Ingreso</span>
            </Link>
            <Link className="d-flex align-items-center ps-4 text-decoration-none text-success" to={"/crud-page-salidas"}>
